...
import fr.utt.utils.url.src.dbHandler.TestDB;
import fr.utt.utils.url.src.featureTagging.FeatureTagging;
...
public static void storeFeatures() throws SQLException, UnknownHostException, TextParseException, MalformedURLException, ParseException{
	TestDB tb=new TestDB();
